...
from dataset.total_text import Testloader,TotalText_test
from util.option import BaseOptions
from util.config import config as cfg, update_config, print_config
from torch.autograd import Variable
img_path = '/data/data_weijia/Kaggle/yibao_competition/seg_data_02_01/number_segment_1/test/'
output_path = '/home/weijia.wu/workspace/Kaggle/Word_segementation/base_text_segementation_5/Demo/out/'
