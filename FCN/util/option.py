...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--num_workers', default=15, type=int, help='Number of workers used in dataloading')
        self.parser.add_argument('--cuda', default=True, type=str2bool, help='Use cuda to train model')
        self.parser.add_argument('--save_dir', default='/home/weijia.wu/workspace/Kaggle/Word_segementation/base_text_segementation_5/save_model/', help='Path to save checkpoint models')
        self.parser.add_argument('--vis_dir', default='/home/weijia.wu/workspace/Kaggle/Word_segementation/base_text_segementation_5/Demo/', help='Path to save visualization images')
        ...
        self.parser.add_argument('--batch_size', default=15, type=int, help='Batch size for training')
