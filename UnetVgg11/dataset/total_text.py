...
class TotalText(data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        one_mask_weight_1 = -(one_mask_weight - one_mask_weight.max() * one_mask) / one_mask_weight.max() * 2 + 1
        two_mask_weight_2 = -(two_mask_weight - two_mask_weight.max() * two_mask) / two_mask_weight.max() * 2 + 1
