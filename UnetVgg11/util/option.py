...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--save_dir', default='/home/weijia.wu/workspace/Kaggle/Word_segementation/Carvana_Image/UnetVgg11/save_model/', help='Path to save checkpoint models')
        self.parser.add_argument('--vis_dir', default='/home/weijia.wu/workspace/Kaggle/Word_segementation/Carvana_Image/UnetVgg11/Demo/', help='Path to save visualization images')
        ...
        self.parser.add_argument('--batch_size', default=5, type=int, help='Batch size for training')
